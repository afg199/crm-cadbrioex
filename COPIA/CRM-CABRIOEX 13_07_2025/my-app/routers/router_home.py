...
from controllers.funciones_home import (
    ...
    obtener_datos_poblacion,
    obtener_datos_servicios,
    obtener_poblaciones,
    obtener_servicios_por_mes,
...
def dashboard():
    if 'conectado' in session:
        ...
        datos_poblacion = obtener_datos_poblacion()
        datos_servicios = obtener_datos_servicios()
        poblaciones = obtener_poblaciones()
        servicios_mes = obtener_servicios_por_mes()
